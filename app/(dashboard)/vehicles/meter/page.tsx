    ...
    <div className="p-6 max-w-[1800px] mx-auto">
      ...
      <div className="flex flex-wrap gap-4 mb-6 bg-gray-50 p-3 rounded-lg border border-gray-200 items-center">
         <div className="relative flex-1 min-w-[200px]">
            ...
            <input type="text" placeholder="Search meter readings..." className="w-full pl-9 pr-4 py-1.5 border border-gray-300 rounded text-sm focus:ring-[#008751] focus:border-[#008751]" />
         </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
        ...
        <h3 className="text-lg font-medium text-gray-900 mb-2">No meter readings found</h3>
        <p className="text-gray-500 mb-4">Get started by adding your first meter reading.</p>
        <button 
          onClick={handleAdd}
