        ...
        <div className="bg-gray-50 min-h-screen pb-12">
            ...
            <div className="bg-white border-b border-gray-200 px-8 py-4 sticky top-0 z-10 flex justify-between items-center">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">Recharge #{params.id || '295871221'}</h1>
                </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-4">
	                                <div className="grid grid-cols-[200px_1fr] border-b border-gray-100 pb-3">
	                                    ...
	                                    <div className="flex items-center gap-2">
	                                        <div className="w-8 h-8 rounded bg-gray-200 flex items-center justify-center overflow-hidden">
	                                            <img src={`https://source.unsplash.com/random/50x50/?electric-car`} className="w-full h-full object-cover" alt="Véhicule" />
	                                        </div>
	                                ...
	                                <div className="grid grid-cols-[200px_1fr] border-b border-gray-100 pb-3">
	                                    <div className="text-sm text-gray-500">Début de charge</div>
	                                    <div className="text-sm text-gray-900 underline decoration-dotted underline-offset-4">12/14/2025 3:49pm</div>
	                                </div>

	                                <div className="grid grid-cols-[200px_1fr] border-b border-gray-100 pb-3">
	                                    <div className="text-sm text-gray-500">Fin de charge</div>
	                                    <div className="text-sm text-gray-900 underline decoration-dotted underline-offset-4">12/14/2025 3:49pm</div>
	                                </div>
                        ...
                        <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 grid grid-cols-4 gap-6">
                            ...
                            <div>
                                <div className="text-xs text-gray-500 font-medium mb-1">Prix moyen de l’énergie</div>
                                <div className="text-xl font-bold text-gray-900">MGA 0.00 <span className="text-xs font-normal text-gray-500">/ kWh</span></div>
                                <div className="text-xs text-gray-400 font-medium mt-1">—</div>
                            </div>
                            <div>
                                <div className="text-xs text-gray-500 font-medium mb-1">Coût total</div>
                            ...
                            <div className="mt-4">
                                ...
                                <div className="text-xl font-bold text-gray-900">0 <span className="text-xs font-normal text-gray-500">heures</span></div>
                                <div className="text-xs text-gray-400 font-medium mt-1">—</div>
                            </div>
                            <div className="mt-4">
                                <div className="text-xs text-gray-500 font-medium mb-1">Efficacité énergétique</div>
                                <div className="text-xl font-bold text-gray-900">— <span className="text-xs font-normal text-gray-500"></span></div>
                                <div className="text-xs text-gray-400 font-medium mt-1">—</div>
                            </div>
                            <div className="mt-4">
                                <div className="text-xs text-gray-500 font-medium mb-1">Coût par heure</div>
                                <div className="text-xl font-bold text-gray-900">MGA 0 <span className="text-xs font-normal text-gray-500">/ heure</span></div>
                                <div className="text-xs text-gray-400 font-medium mt-1">—</div>
                            </div>
                        </div>
                    </div>
