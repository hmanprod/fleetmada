            ...
            <div className="bg-white border-b border-gray-200 px-8 py-4 sticky top-0 z-10 flex justify-between items-center">
                <div className="flex items-center gap-4">
                    <button onClick={handleBack} className="text-gray-500 hover:text-gray-700 flex items-center gap-1 text-sm font-medium">
                        <ArrowLeft size={16} /> Fuel History
                    </button>
                    <h1 className="text-2xl font-bold text-gray-900">Fuel Entry #{params.id || '195961220'}</h1>
                </div>
                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-[200px_1fr] border-b border-gray-100 pb-3">
                                    ...
                                    <div className="text-sm text-gray-900 underline decoration-dotted underline-offset-4">160 mi</div>
                                </div>
                                ...
                                <div className="grid grid-cols-[200px_1fr] border-b border-gray-100 pb-3">
                                    <div className="text-sm text-gray-500">Fuel Card</div>
                        ...
                        <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 grid grid-cols-4 gap-6">
                            ...
                            <div>
                                <div className="text-xs text-gray-500 font-medium mb-1">Fuel Price</div>
                                <div className="text-xl font-bold text-gray-900">MGA 3.7950 <span className="text-xs font-normal text-gray-500">/ gallon</span></div>
                            ...
                            <div className="mt-4">
                                ...
                                <div className="text-xl font-bold text-gray-900">96.0 <span className="text-xs font-normal text-gray-500">miles</span></div>
                                <div className="text-xs text-green-600 font-medium mt-1">▲ 81.45 (559.8%)</div>
                            </div>
                            <div className="mt-4">
                                <div className="text-xs text-gray-500 font-medium mb-1">Fuel Economy</div>
                                <div className="text-xl font-bold text-gray-900">0.67 <span className="text-xs font-normal text-gray-500">mpg (US)</span></div>
                            ...
                            <div className="mt-4">
                                ...
                                <div className="text-xl font-bold text-gray-900">MGA 0 <span className="text-xs font-normal text-gray-500">/ mile</span></div>
