        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-6 space-y-6">
            ...
            {/* <div className="pt-6 border-t border-gray-100">
              <h2 className="text-lg font-bold text-gray-900 mb-4">Préférences d'affichage</h2>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Affichage de la consommation</label>
                  <select
                    value={formData.fuelEconomyDisplay}
                    onChange={(e) => handleInputChange('fuelEconomyDisplay', e.target.value)}
                    className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]"
                  >
                    <option value="L/100km · L/100hr · Litres">L/100km · L/100hr · Litres</option>
                    <option value="MPG (US) · GPH · Gallons">MPG (US) · GPH · Gallons</option>
                    <option value="MPG (UK) · GPH · Gallons">MPG (UK) · GPH · Gallons</option>
                    <option value="km/L · L/100hr · Litres">km/L · L/100hr · Litres</option>
                  </select>
                </div>
