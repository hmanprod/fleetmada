...
import { Search, Plus, Filter, MoreHorizontal, ChevronRight, ChevronDown, Settings, Lightbulb, Grid } from 'lucide-react';
  ...
  return (
    <div className="p-6 max-w-[1800px] mx-auto">
      ...
      <div className="flex gap-1 border-b border-gray-200 mb-6">
        ...
        >
          All <span className="bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded-full text-xs">...</span>
        </button>
        <button
                ...
                <td colSpan={9} className="px-6 py-24 text-center">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm text-gray-400 mb-6 max-w-md text-center">
                      ...
                      <br />
                      <button className="text-[#008751] hover:underline font-medium">Learn More</button>
                    </p>
                    <button
                      onClick={handleAddPart}
                      className="bg-[#008751] hover:bg-[#007043] text-white font-bold py-2 px-4 rounded flex items-center gap-2"
