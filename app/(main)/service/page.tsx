...
const handleAdd = () => {
  // TODO: Implement add service program functionality
  console.log('Add service program');
};

const handleSelect = (program: ServiceProgram) => {
  // TODO: Implement select service program functionality
  console.log('Select service program:', program);
};
        ...
        <table className="min-w-full divide-y divide-gray-200">
           ...
           <tbody className="divide-y divide-gray-200">
              {mockPrograms.map(prog => (
                 <tr key={prog.id} className="hover:bg-gray-50 cursor-pointer" onClick={() => handleSelect(prog)}>
