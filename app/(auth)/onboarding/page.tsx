        ...
        <div className="grid grid-cols-3 gap-3">
          {['1-10', '11-50', '51-200', '201-500', '500+'].map((size) => (
            <button
              ...
              className={`border rounded-md py-3 px-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#008751] focus:border-transparent transition-all ${formData.fleetSize === size
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 gap-4">
        {[
          ...
          <div key={idx} className={`relative flex items-start p-4 border rounded-lg cursor-pointer transition-all ${formData.objectives.includes(item.id)
...
// Page principale avec protection d'authentification
