...
import { Search, Plus, Filter, MoreHorizontal, ChevronRight, ChevronDown, FileText, Upload, Folder } from 'lucide-react';
...
const DocumentList: React.FC<DocumentListProps> = ({ onUpload }) => {
  return (
    <div className="p-6 max-w-[1800px] mx-auto">
      ...
      <div className="flex gap-4 border-b border-gray-200 mb-6">
         <button className="px-4 py-2 text-sm font-medium border-b-2 border-[#008751] text-[#008751] flex items-center gap-2">
             <FileText size={16} /> All Documents
         </button>
         <button className="px-4 py-2 text-sm font-medium border-transparent text-gray-500 hover:text-gray-700 flex items-center gap-2">
             <Folder size={16} /> ONNO
         </button>
      </div>
      ...
      <div className="flex flex-wrap gap-4 mb-6 bg-gray-50 p-3 rounded-lg border border-gray-200 items-center">
         ...
         <button className="bg-white border border-gray-300 px-3 py-1.5 rounded text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center gap-2">
               Document File Type <ChevronDown size={14}/>
          </button>
          <button className="bg-white border border-gray-300 px-3 py-1.5 rounded text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center gap-2">
               Document Location Type <ChevronDown size={14}/>
          </button>
         <button className="bg-white border border-gray-300 px-3 py-1.5 rounded text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center gap-2">
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden h-96 flex flex-col items-center justify-center">
          ...
          <p className="text-sm text-gray-400 mb-4 max-w-md text-center">Documents help you organize and manage critical files related to your fleet.</p>
