...
const ContactCreate: React.FC<ContactCreateProps> = ({ onCancel, onSave, initialData }) => {
    ...
    <div className="bg-gray-50 min-h-screen">
       <div className="bg-white border-b border-gray-200 px-8 py-4 sticky top-0 z-10 flex justify-between items-center">
         <div className="flex items-center gap-4">
             ...
             {isEdit && <div className="text-sm text-gray-500">Contacts / {firstName} {lastName}</div>}
         ...
         <div className="flex gap-3">
             ...
             {!isEdit && <button className="px-4 py-2 text-gray-700 font-medium hover:bg-gray-100 rounded border border-gray-300 bg-white">Add Multiple Contacts</button>}
             <button onClick={onSave} className="px-4 py-2 bg-[#008751] hover:bg-[#007043] text-white font-bold rounded shadow-sm">Save Contact</button>
         </div>
       </div>
             ...
             <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" value={firstName} onChange={e => setFirstName(e.target.value)} className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <input type="text" value={lastName} onChange={e => setLastName(e.target.value)} className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                </div>

                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
                    <input type="email" defaultValue={initialData?.email} className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                ...
                <div>
                    ...
                    <select className="w-full p-2.5 border border-gray-300 rounded-md bg-white focus:ring-[#008751] focus:border-[#008751]">
                        ...
                        <option selected={initialData?.group === 'Atlanta'}>Atlanta</option>
                ...
                <div>
                    ...
                    {initialData?.image && (
                        <div className="mb-2">
                            <img src={initialData.image} alt="Profile" className="h-16 w-16 rounded-md object-cover" />
                        </div>
                    )}
                    ...
                    {!initialData?.image && <p className="mt-1 text-xs text-gray-500 italic">No file selected</p>}
                </div>
             </div>
             ...
             <div className="mt-8 border-t border-gray-100 pt-6">
                 ...
                 <div className="grid grid-cols-2 gap-4">
                     <label className="flex items-start gap-3">
                         <input type="checkbox" defaultChecked={initialData?.classifications?.includes('Operator')} className="mt-1 text-[#008751] focus:ring-[#008751] rounded" />
                         <div>
                     ...
                     <label className="flex items-start gap-3">
                         <input type="checkbox" defaultChecked={initialData?.classifications?.includes('Employee')} className="mt-1 text-[#008751] focus:ring-[#008751] rounded" />
                         <div>
                     ...
                     <label className="flex items-start gap-3">
                         <input type="checkbox" defaultChecked={initialData?.classifications?.includes('Technician')} className="mt-1 text-[#008751] focus:ring-[#008751] rounded" />
                         <div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
             ...
             <div className="grid grid-cols-2 gap-4 space-y-2">
                 <div>
                    ...
                    <input type="text" defaultValue={initialData?.phone} placeholder="404-555-0123" className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                 </div>
                 <div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
             ...
             <div className="space-y-4">
                 <div>
                    ...
                    <input type="text" defaultValue={initialData?.jobTitle} placeholder="e.g. Assistant to the Regional Manager" className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                 </div>
                 <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Date of Birth</label>
                    <input type="date" defaultValue="1986-05-26" className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                 </div>
                 <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Employee Number</label>
                    <input type="text" defaultValue="D103" className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                 </div>
                 <div className="grid grid-cols-2 gap-4">
                     <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Start Date</label>
                        <input type="date" defaultValue="2024-11-14" className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                     </div>
                     <div>
                 ...
                 <div>
                    ...
                    <input type="text" defaultValue="74930284" className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                 </div>
                 <div className="grid grid-cols-2 gap-4">
                     <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">License Class</label>
                        <input type="text" defaultValue="A" className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                     </div>
                     <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">License State/Province/Region</label>
                        <input type="text" defaultValue="Georgia" className="w-full p-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                     </div>
                 </div>
                 <div>
