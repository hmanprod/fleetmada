...
interface ServiceTaskCreateProps {
  onCancel: () => void;
  onSave: () => void;
}

const ServiceTaskCreate: React.FC<ServiceTaskCreateProps> = ({ onCancel, onSave }) => {
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="bg-white border-b border-gray-200 px-8 py-4 flex justify-between items-center sticky top-0 z-10">
        ...
        <div className="flex gap-3">
           ...
           <button onClick={onSave} className="px-4 py-2 bg-[#008751] hover:bg-[#007043] text-white font-bold rounded shadow-sm">Save Service Task</button>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto py-8 px-4 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
           <div className="p-4 border-b border-gray-200 flex items-center gap-3">
              <div className="h-6 w-6 rounded-full bg-gray-200 text-gray-600 flex items-center justify-center text-sm font-bold">1</div>
           ...
           <div className="p-6 space-y-6">
              <div>
                 ...
                 <p className="mt-1 text-xs text-gray-500">A brief title for your unique task. <a href="#" className="text-[#008751]">See examples</a> of FleetMada's comprehensive list of Standard Service Tasks that cover most common repairs and maintenance.</p>
              </div>
              ...
              <div>
                 ...
                 <div className="relative">
                    ...
                    <input type="text" placeholder="Select Service Tasks" className="w-full pl-9 pr-4 py-2.5 border border-gray-300 rounded-md focus:ring-[#008751] focus:border-[#008751]" />
                 </div>
                 <p className="mt-1 text-xs text-gray-500">Only Service Tasks without Subtasks can be added.</p>
              </div>
              
               <div className="flex justify-end pt-2">
                 <button className="text-gray-500 font-medium hover:text-gray-700 mr-4">Cancel</button>
                 <button className="bg-gray-100 text-gray-400 font-bold py-2 px-4 rounded cursor-not-allowed">Continue</button>
               </div>
           </div>
        </div>
