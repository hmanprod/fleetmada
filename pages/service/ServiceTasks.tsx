...
import { Search, Plus, Filter, MoreHorizontal, ChevronRight, FileText } from 'lucide-react';
...
const ServiceTasks: React.FC<ServiceTasksProps> = ({ onAdd }) => {
  return (
    <div className="p-6 max-w-[1800px] mx-auto">
      ...
      <div className="flex gap-4 mb-6 text-sm font-medium border-b border-gray-200">
         <button className="pb-3 border-b-2 border-[#008751] text-[#008751]">Active</button>
         <button className="pb-3 border-b-2 border-transparent text-gray-500 hover:text-gray-700">Archived</button>
      </div>
          ...
          <tbody className="divide-y divide-gray-200">
             {mockTasks.map(task => (
                <tr key={task.id} className="hover:bg-gray-50">
                   ...
                   <td className="px-4 py-3 font-medium text-gray-900 underline decoration-dotted underline-offset-4 cursor-pointer">{task.name} <span className="ml-1 inline-block bg-gray-100 text-gray-600 text-[10px] px-1 rounded">S</span></td>
